...
type Args struct {
	Entity string         `json:"entity" jsonschema:"api | random"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.WoodySDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "woody_list",
		Description: "List records from Woody. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "woody_load",
		Description: "Load a single record from Woody. " +
...
func runOp(client *sdk.WoodySDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.WoodySDK, name string) (sdk.WoodyEntity, error) {
