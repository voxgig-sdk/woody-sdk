...
module WoodyTestRunner
  ...
  def self.env_override(m)
    live = getenv("WOODY_TEST_LIVE")
    override = getenv("WOODY_TEST_OVERRIDE")
    ...
    explain = getenv("WOODY_TEST_EXPLAIN")
    m["WOODY_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = WoodyTestRunner
Helpers = WoodyHelpers
Vs = VoxgigStruct
