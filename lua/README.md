...
The Lua SDK for the Woody API — an entity-oriented client using Lua conventions.
...
## Install
```bash
luarocks install voxgig-sdk-woody
```
...
local result, err = client:Woody():load({ id = "test01" })
...
The main module (`woody_sdk`) exports the SDK constructor
