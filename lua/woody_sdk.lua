...
WoodySDK._make_feature = _make_feature


function WoodySDK.new(options)
  local self = setmetatable({}, WoodySDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function WoodySDK:get_utility()
  return Utility.copy(self._utility)
end


function WoodySDK:get_root_ctx()
  return self._rootctx
end


function WoodySDK:prepare(fetchargs)
...
function WoodySDK:direct(fetchargs)
...
-- by passing it.
function WoodySDK:_raw_request(fetchargs)
  local utility = self._utility
...
function WoodySDK:graphql(query, variables, ctrl)
...
function WoodySDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = WoodySDK.new(sdkopts)
  sdk.mode = "test"
