...
from woody_sdk.core.response import WoodyResponse
from woody_sdk.core.operation import WoodyOperation
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = WoodySDK.test(None, None)
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(WoodyBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = WoodySDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = WoodySDK.test(None, setup_opts)
