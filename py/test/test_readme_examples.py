# Woody SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions WoodySDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both WoodySDK(...) and WoodySDK.test(...) become
#      WoodySDK.test({"entity": {...}}) seeding one mock record (id "test01")
