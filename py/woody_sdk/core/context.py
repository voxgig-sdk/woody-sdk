...
from woody_sdk.core.helpers import get_ctx_prop, to_map
...
class WoodyContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, WoodyResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return WoodyError(code, msg, self)
