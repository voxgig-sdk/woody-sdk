...
from woody_sdk.utility import register

# Load features
from woody_sdk.feature.base_feature import WoodyBaseFeature
from woody_sdk.features import _has_feature, _make_feature
...
class WoodySDK:
    ...
    def get_utility(self):
        return WoodyUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("WoodySDK: graphql: " + str(msg))
            res["graphql"] = errors
