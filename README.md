...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/woody` | `npm install @voxgig-sdk/woody` |
| Python | `voxgig-sdk-woody` | `pip install voxgig-sdk-woody` |
| PHP | `voxgig-sdk/woody` | `composer require voxgig-sdk/woody` |
| Golang | `github.com/voxgig-sdk/woody-sdk/go` | `go get github.com/voxgig-sdk/woody-sdk/go` |
| Ruby | `voxgig-sdk-woody` | `gem install voxgig-sdk-woody` |
| Lua | `voxgig-sdk-woody` | `luarocks install voxgig-sdk-woody` |
