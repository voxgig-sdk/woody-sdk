...
class WoodyTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = WoodyTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = WoodyTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = WoodyTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
