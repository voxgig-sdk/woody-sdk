...
class WoodyTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = WoodyTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = WoodyTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = WoodyTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
