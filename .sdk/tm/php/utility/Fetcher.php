...
class WoodyFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; WoodySDK/1.0)';
    ...
    public static function call(WoodyContext $ctx, string $fullurl, array $fetchdef): array
    {
