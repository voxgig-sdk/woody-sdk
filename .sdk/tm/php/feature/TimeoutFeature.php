...
class WoodyTimeoutFeature extends WoodyBaseFeature
{
    ...
    private function _with_timeout(WoodyContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(WoodyContext $_ctx, float $ms): void
    {
        $client = $this->client;
