...
class WoodyRatelimitFeature extends WoodyBaseFeature
{
    ...
    private function _acquire(WoodyContext $ctx): void
    {
    ...
    private function _track(WoodyContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
