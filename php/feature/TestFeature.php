...
// Woody SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class WoodyTestFeature extends WoodyBaseFeature
{
    ...
    public function init(WoodyContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (WoodyContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (WoodyContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(WoodyContext $ctx, $op, $args): array
    {
