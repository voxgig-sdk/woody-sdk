...
class WoodyRbacFeature extends WoodyBaseFeature
{
    ...
    private function _required(WoodyContext $ctx): ?string
    {
    ...
    private function _reject(WoodyContext $ctx, string $required): void
    {
    ...
    private function _track(WoodyContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
