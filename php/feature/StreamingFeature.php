...
class WoodyStreamingFeature extends WoodyBaseFeature
{
    ...
    private function _iterate(WoodyResult $result): \Generator
    {
    ...
    private function _streamable(WoodyContext $ctx): bool
    {
