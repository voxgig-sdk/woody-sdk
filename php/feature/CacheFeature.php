...
class WoodyCacheFeature extends WoodyBaseFeature
{
    ...
    private function _through(WoodyContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
