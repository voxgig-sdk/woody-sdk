...
class WoodyProxyFeature extends WoodyBaseFeature
{
    ...
    public function init(WoodyContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (WoodyContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
