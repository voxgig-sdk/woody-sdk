...
class WoodyClienttrackFeature extends WoodyBaseFeature
{
    ...
    public function PostConstruct(WoodyContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Woody-SDK';
