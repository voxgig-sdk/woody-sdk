...
// Woody SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class WoodyMakeRequest
{
    public static function call(WoodyContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new WoodyResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new WoodyResponse($fetched);
        } else {
