...
// Woody SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (WoodySDK::test)
...
{
    private const SDK_CLASS = 'WoodySDK';
    ...
    private const SDK_BASE = 'woody_sdk';
