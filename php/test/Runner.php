...
class WoodyTestRunner
{
    ...
    {
        $live = self::getenv('WOODY_TEST_LIVE');
        $override = self::getenv('WOODY_TEST_OVERRIDE');
        ...
        $explain = self::getenv('WOODY_TEST_EXPLAIN');
...
class_alias('WoodyTestRunner', 'Runner');
class_alias('WoodyHelpers', 'Helpers');
