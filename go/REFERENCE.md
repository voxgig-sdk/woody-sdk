# Woody Golang SDK Reference

Complete API reference for the Woody Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *WoodySDK`
...
#### `Api(data map[string]any) WoodyEntity`

Create a new `Api` entity instance. Pass `nil` for no initial data.

#### `Random(data map[string]any) WoodyEntity`
