...
func (sdk *WoodySDK) OptionsMap() map[string]any {
...
func (sdk *WoodySDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *WoodySDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *WoodySDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *WoodySDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *WoodySDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *WoodySDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("WoodySDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *WoodySDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *WoodySDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("WoodySDK: graphql: %s", msg)
		res["graphql"] = errors
	}
