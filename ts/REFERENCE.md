# Woody TypeScript SDK Reference

Complete API reference for the Woody TypeScript SDK.
...
#### `WoodySDK.test(testopts?, sdkopts?)`
...
**Returns:** `WoodySDK` instance in test mode.
...
Return the parent `WoodySDK` instance.
