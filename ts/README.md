# Woody TypeScript SDK



The TypeScript SDK for the Woody API — a type-safe, entity-oriented client with full async/await support.
...
- Releases: [https://github.com/voxgig-sdk/woody-sdk/releases](https://github.com/voxgig-sdk/woody-sdk/releases)
...
| `tester(testopts?, sdkopts?)` | `WoodySDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `WoodySDK.test(testopts?, sdkopts?)` | `WoodySDK` | Create a test-mode client. |
...
| `client` | `client(): WoodySDK` | Return the parent SDK client. |
